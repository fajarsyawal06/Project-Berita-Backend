...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rolePermissions = [
            ...
            'P-04' => ['news.create', 'news.verify', 'news.queue.view', 'news.force_publish', 'news.bookmark', 'reports.view', 'reports.generate', 'reports.adhoc', 'reports.national', 'master_data.manage', 'tutorial_data.manage', 'dashboard.view', 'dashboard.share'],
            'P-05' => []
        ];
